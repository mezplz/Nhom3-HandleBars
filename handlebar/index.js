...
app.get('/task2.htm', function(req, res){
    res.render('task2')
})

app.get('/task3.htm', function(req, res){

    res.render('task3', context3)
})

app.get('/task4.htm', function(req, res){

    res.render('task4', context4)
})

app.get('/task3.htm-ss', function(req, res){
  let ss = {products: []}
  for (let i = 0 ; i < context3.products.length ; i++){
    if (context3.products[i].category == 1){
      ss.products.push(context3.products[i])
    }
  }
  res.render('task3', ss)
})

app.get('/task3.htm-sn', function(req, res){
  let ss = {products: []}
  for (let i = 0 ; i < context3.products.length ; i++){
    if (context3.products[i].category == 2){
      ss.products.push(context3.products[i])
    }
  }
  res.render('task3', ss)
...
app.get('/task3.htm-pn', function(req, res){
  let ss = {products: []}
  for (let i = 0 ; i < context3.products.length ; i++){
    if (context3.products[i].category == 3){
      ss.products.push(context3.products[i])
    }
  }
  let i = 0;
...
for (let i = 0 ; i < context4.zodiacs.length ; i++){
  let link = "/task4-details.htm-" + i.toString()
  app.get(link, function(req, res){

      res.render('task4-details', context4.zodiacs[i])
  })
}
